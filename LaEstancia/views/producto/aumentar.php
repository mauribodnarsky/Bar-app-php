 ...
 <a href="<?=base_url?>/" ><input id="btn-producto-nuevo" type="button" class="btn btn-warning" style="margin-top: 70px;font-weight: 500;"value="Nuevo Producto"></a>
      ...
      <table class="table table-striped col-12" id="productos-result"  style="table-layout: fixed;overflow-wrap: break-word; text-align: center;">    
          ...
          <thead>
            <tr  style="background-color: #bfbfa4;">
              ...
              <th style="width:301px;" >Producto</th>
   ...
   <tr  <?php if(($pro['alerta_stock'])>=($pro['stock'])) : ?> style="background: #d9675f;" <?php else : ?>style="background: #78e37f;" <?php endif;?>>
      ...
      <td style="vertical-align: middle;">
        <a href="<?=base_url?>/?controller=producto&action=agregar&id=<?php echo $pro['id'];?>&nombre=<?php echo $pro['nombre'];?>&precio=<?php echo $pro['precio'];?>" class="btn btn-warning" style="display:inline-block;margin-bottom:4px;color: #c7c548;font-weight: 500;background:white;border-color:#c7c548;width: 95px;">Aumento</a>
      </td>
    </tr> 
  <?php endforeach; ?> 
    </tbody>
         ...
         <div class="col-4" style="margin-top:70px; float:right;display: inline-block;">
            <h1 style="display: inline-block;margin-top: 60px;    margin-left: 44px;">Aumentar Precios</h1>
